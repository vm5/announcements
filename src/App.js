  ...
  return (
    <Container1>
      {!isCodeValid ? (
        ...
        <Container2>
          <NewSticker>New</NewSticker><Title>Welcome to Prodigy Peak! All announcements with regards to classes shall be put up here. All students are expected to keep in touch with the portal regularly.</Title>
        </Container2>
      )}
    </Container1>
  );
